 ...
 * visível em todas as páginas. Abre conversa com mensagem pré-preenchida.
 */
export function WhatsAppButton() {
	return (
		...
		>
			...
			<span
				aria-hidden="true"
				className="pointer-events-none absolute right-full mr-3 hidden whitespace-nowrap rounded-full bg-smoke px-4 py-2 font-mono text-xs text-bone opacity-0 shadow-lg transition-opacity duration-300 group-hover:opacity-100 md:block"
			>
				Falar no WhatsApp
			</span>
		</a>
